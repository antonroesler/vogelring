...
class TestSuggestionsAPI:
    ...
    def test_get_all_suggestions_with_data(
        self, client, multiple_test_sightings, multiple_test_ringings
    ):
...
class TestSuggestionsWithVariousFields:
    ...
    def test_suggestions_frequency_ordering(
        self, client, sightings_with_various_fields
    ):
