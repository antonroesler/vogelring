...
class TestSightingsAPI:
    ...
    def test_get_sightings_by_radius(self, client, multiple_test_sightings):
        ...
        response = client.get("/api/sightings/radius?lat=52.5200&lon=13.4050&radius_m=1000")
        assert response.status_code == 200
        data = response.json()
    ...
    def test_get_autocomplete_suggestions_with_limit(self, client, multiple_test_sightings):
    ...
    def test_get_enriched_sightings(self, client, create_test_sighting, create_test_ringing):
