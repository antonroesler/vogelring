...
class SightingService:
    ...
    def get_enriched_sightings(
        ...
        return self.repository.get_enriched_sightings(
    ...
    def get_sightings_by_date_range(
    ...
    def get_sightings_by_radius(
        self, lat: float, lon: float, radius_m: int, org_id: str
    ) -> List[SightingDB]:
    ...
    def update_sighting(
        self, sighting_id: str, org_id: str, sighting_data: Dict[str, Any]
    ) -> Optional[SightingDB]:
        ...
        try:
            ...
            updated_sighting = self.repository.update(
                sighting_id, org_id, **sighting_data
            )
