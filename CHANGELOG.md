...
## [3.0.0](https://github.com/antonroesler/vogelring/compare/v2.9.2...v3.0.0) (2026-09-24)
...
* Excel export of Wiederfunde for Vogelwarte RING import ([452a7d2](https://github.com/antonroesler/vogelring/commit/452a7d2a935b4c7c3af17251acdddaeee8398228))
...
* export history with bulk "gemeldet" marking ([b8c1d0e](https://github.com/antonroesler/vogelring/commit/b8c1d0ee442ca6251b36059040e3f6a47508accf))
...
* finalize Bemerkungen field per Ingo's spec ([1a22b22](https://github.com/antonroesler/vogelring/commit/1a22b2294f11839d5d93ebd36b3d18ed0bb1644c))
...
* migrate sighting age/sex to RING (EURING) integer codes ([669d90a](https://github.com/antonroesler/vogelring/commit/669d90a94c90759a1c7c77d7ebf2c7ef72a33b27))
...
* RING age classes 9–D + Alter 0, place↔RING coord mapping, Bemerkungen export ([baa508c](https://github.com/antonroesler/vogelring/commit/baa508c3ae7394191f8e8e0e9a0dd5237a32fd51))
...
* smart place mapping — GPS-nearest RING place fallback for unmapped places ([2731aca](https://github.com/antonroesler/vogelring/commit/2731aca45a0ef5340e0bdc15cb922b8d77d9f008))
...
* authenticate CARTO basemap requests ([4ecece7](https://github.com/antonroesler/vogelring/commit/4ecece7bc14dac0bde54fff1eecb9276aeaddce7))
...
* display official RING species names throughout the app ([#62](https://github.com/antonroesler/vogelring/issues/62)) ([fa250f8](https://github.com/antonroesler/vogelring/commit/fa250f869680e3b2a7acca9b7d91587fef43ab58))
...
* idempotent family relationships so linked children + form reset survive ([5ea3a24](https://github.com/antonroesler/vogelring/commit/5ea3a24b3e4319a727f101ae9d243b9fb4ccd074))
* increase API timeout ([e95737c](https://github.com/antonroesler/vogelring/commit/e95737c49d8b67efeedc22795cc9e1f95ba13bd4))
* isolate bird identities and metadata by organization ([4114e4b](https://github.com/antonroesler/vogelring/commit/4114e4b6ed9f3d4d468482a1ff5d80a11e9f534b))
...
* migration handles v_sightings view dependency + Dockerfile copies scripts ([85818c4](https://github.com/antonroesler/vogelring/commit/85818c4204fe969223c76845087d441ce65ca2c2))
* normalize Wiederfunde-Export age column + add date-range picker ([debf62e](https://github.com/antonroesler/vogelring/commit/debf62e38e64a0262ffc1628857a1b03e244a224))
...
* RING Status only for Brutvogel/Mausergast, else blank ([4c291d9](https://github.com/antonroesler/vogelring/commit/4c291d918a2eb253457df033ef0d4e1a8344938a))
...
* use exec_driver_sql for v_sightings DDL in age/sex migration ([def2729](https://github.com/antonroesler/vogelring/commit/def272967126d9f755df175484dec60fdb52286b))
...
* release 2.0.0 ([#37](https://github.com/antonroesler/vogelring/issues/37)) ([9826fbc](https://github.com/antonroesler/vogelring/commit/9826fbcdf2760276bc501eced0549cee1dc636e6))
* release 2.1.0 ([#38](https://github.com/antonroesler/vogelring/issues/38)) ([843f5b1](https://github.com/antonroesler/vogelring/commit/843f5b1ce6fdb7618591e58def4eb04a6300a4f0))
* release 2.2.0 ([#45](https://github.com/antonroesler/vogelring/issues/45)) ([fe13287](https://github.com/antonroesler/vogelring/commit/fe132878cdccc8da2d95fef6f5e9b9bc14ecfb3c))
* release 2.3.0 ([#50](https://github.com/antonroesler/vogelring/issues/50)) ([99a2cc7](https://github.com/antonroesler/vogelring/commit/99a2cc78ddcda57f433e38d3d0ff1b95781c3725))
* release 2.4.0 ([#51](https://github.com/antonroesler/vogelring/issues/51)) ([87f901d](https://github.com/antonroesler/vogelring/commit/87f901d49ca4a1b503e3e2277038149f8a33e2d7))
* release 2.5.0 ([#52](https://github.com/antonroesler/vogelring/issues/52)) ([11bbf2e](https://github.com/antonroesler/vogelring/commit/11bbf2e0790f5b0afd988aafceccb4786198b1a5))
* release 2.6.0 ([#53](https://github.com/antonroesler/vogelring/issues/53)) ([5826144](https://github.com/antonroesler/vogelring/commit/5826144e312b51157b9a77368397938ebb221c74))
* release 2.7.0 ([#59](https://github.com/antonroesler/vogelring/issues/59)) ([efb1362](https://github.com/antonroesler/vogelring/commit/efb1362c6ccef6eb37dc000b17b7b47b6d890464))
* release 2.8.0 ([87b6adb](https://github.com/antonroesler/vogelring/commit/87b6adb26281e2b4e335f69ff86ec869509c491b))
* release 2.9.0 ([9709d00](https://github.com/antonroesler/vogelring/commit/9709d00b9b8696685d654e4a63cc4a73097e1dc6))
* release 2.9.1 ([364a647](https://github.com/antonroesler/vogelring/commit/364a647b7df508b8f5d9ce9bcdcaa986836b320c))
* release 2.9.2 ([bc89edf](https://github.com/antonroesler/vogelring/commit/bc89edf6ae3ba9f09622bdd372bb545851bca558))
...
## [2.9.2](https://github.com/antonroesler/vogelring/compare/v2.9.1...v2.9.2) (2026-07-19)


### 🐛 Bug Fixes

* **Export:** RING-Status nur für Brutvogel (→ nestbauend oder brütend) und Mausergast (→ in Mausertrupp) setzen; alle anderen/leeren Status bleiben leer statt "unbekannt / nicht erfasst"

## [2.9.1](https://github.com/antonroesler/vogelring/compare/v2.9.0...v2.9.1) (2026-07-19)


### ✨ Features

* **Export:** Bemerkungen-Feld final abgestimmt – Felder in Ingos Reihenfolge (Melder außer bei IR, Groß-/Kleingruppe, Familien Status, Partner, nicht flügge/flügge Junge, Feldfrucht, Kommentare); die Spalten Melder und Kommentar entfallen (in RING keine eigenen Spalten), Habitat und Kleinfläche bleiben außen vor
